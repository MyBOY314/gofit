                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="store">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" v-model="presensiGym.hari"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="select form-control" v-model="presensiGym.kelas_id" placeholder="Pilih Kelas">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="select form-control" v-model="presensiGym.instruktur_id" placeholder="Pilih Instruktur">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="time" class="form-control" v-model="presensiGym.jam" placeholder="Masukkan Jam">
                                <!-- validation -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" v-model="presensiGym.tariff"
...
export default {
    setup() {
        ...
        //method store
        function store() {
            let hari = presensiGym.hari
            let kelas = presensiGym.kelas_id
            let instruktur = presensiGym.instruktur_id
            let jam = presensiGym.jam
            axios.post('http://localhost:8000/api/presensiGym', {
                hari: hari,
                kelas: kelas,
