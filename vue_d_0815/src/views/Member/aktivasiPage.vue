                        ...
                        <form @submit.prevent="update">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" v-model="member.nama_member"
                                    placeholder={{member.nama_member}} readonly>
                                <!-- validation -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" v-model="member.email" placeholder={{member.email}} readonly>
                                <!-- validation -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" v-model="member.nomor_telepon"
                                    placeholder={{member.nomor_telepon}} readonly>
                                <!-- validation -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="date" v-model="member.tanggal_lahir"
                                    placeholder="Masukkan Tanggal Lahir" readonly>
                                <!-- validation -->
