...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body"> <a href="{{ route('departemen.create') }}" class="btn btn-md btn-success mb-3">TAMBAH DEPARTEMEN</a>
                        <div class="table-responsive p-0">
                            <table class="table table-hover textnowrap">
                                ...
                                <tbody> @forelse ($departemen as $item) <tr>
                                    ...
                                    </tr> @empty <div class="alert alert-danger"> Data Departemen belum tersedia </div> @endforelse </tbody>
                            </table>
                        </div>
