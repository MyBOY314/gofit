...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body"><a href="{{ route('pegawai.create') }}" class="btn btn-md btn-success mb-3">TAMBAH Pegawai</a>
                            ...
                            <table class="table table-hover textnowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$item->status==0 ? "Tidak Aktif" : "Aktif" }}</td>
